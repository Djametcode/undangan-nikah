  ...
  return (
    <div data-reveal data-entrance className="group relative overflow-hidden rounded-card border border-primary/15 bg-surface/80 backdrop-blur-sm soft-shadow hover:soft-shadow-lg transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-8 text-center">
        {/* icon */}
        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary-light group-hover:scale-110 transition-transform duration-300">
          <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <h3 className="serif-body text-3xl text-fg font-semibold mb-4">{title}</h3>
        <div className="hairline w-14 mx-auto mb-5" />
        {/* time */}
        <div className="inline-flex items-center gap-2 mb-3">
          ...
          <span className="serif-body text-xl text-primary-light font-medium">{time}</span>
        </div>
        {/* place */}
        <div className="flex items-start justify-center gap-2 text-muted">
          ...
          <span className="serif-body leading-relaxed">{place}</span>
        </div>
        {/* map CTA */}
        <a
          href={mapsUrl} target="_blank" rel="noreferrer"
          className="mt-6 inline-flex items-center gap-2 bg-primary/10 hover:bg-primary text-primary-light hover:text-bg border border-primary/30 px-6 py-2.5 text-xs uppercase tracking-[0.2em] rounded-full transition-all duration-300 cursor-pointer group-hover:shadow-lg"
        >
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="md:hidden flex items-center gap-4 my-1">
            ...
            <span className="serif-body text-primary-light italic">{cfg.event.day}, {cfg.event.date}</span>
            <div className="flex-1 h-px bg-primary/20" />
          </div>
        ...
        {/* tanggal besar di bawah */}
        <div className="text-center mt-10" data-reveal data-entrance>
          <p className="script-display text-4xl md:text-5xl text-primary-light">{cfg.event.day}</p>
          <p className="serif-body text-2xl text-fg mt-2">{cfg.event.date}</p>
        </div>
      </div>
    </section>
  );
